...
public class SolarCalculator {
    ...
    private final Vec_Guo solarOutDirection = DIRECTION_EAST.dup();
     ...
     *
     * @param l latitude of the place to be calculated, positive for northern
     ...
     *
     * @param l latitude, positive for northern hemisphere and negative for
     *          southern hemisphere
     */
     ...
     * set date to be calculated
     *
     * @param ratio between 0(after 22nd Jun) and 1(before 22nd Jun in next year)
     */
    public void setDate(double ratio) {
        // solar direct shoot position
        double solarLatitude = Math.cos(ratio * Math.PI * 2) * ANG_OBLIQUITY;
     ...
     * sphere, at a given time.
     *
     * @param hourRatio between 0 and 1, indicates from 0:00 to 23:59
     * @return Vec_Guo
     */
